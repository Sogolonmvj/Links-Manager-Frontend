        ...
        <div className="row">
            ...
            <div className="alert alert-danger rounded float-center shadow-bold">
                ...
                <div className="d-flex justify-content-between">
                    <button className="btn btn-outline-light" onClick={ cancelDelete }>No, I am not sure!</button>
                    <button className="btn btn-danger" onClick={ confirmDelete }>Yes, I am sure!</button>
                </div>
            </div>
            ) : null}
